...
faq:
  - q: "电子签章签的合同有法律效力吗？"
    a: "依据《电子签名法》第十四条，可靠的电子签名与手写签名或者盖章具有同等法律效力。关键在于是否满足第十三条的四项要件：签名制作数据为签名人专有、签署时仅由签名人控制、签署后对签名和数据电文内容的任何改动能够被发现。不满足要件的“电子章”可能不被法院采信。"
  - q: "哪些情形下电子签章会被法院认定无效？"
    a: "裁判文书中的高频败诉情形包括：电子印章只是普通印刷字体的图片，缺乏专有性和独占性；无法确认由CA机构颁发的有效数字证书签署；电子合同由一方控制保管，无法证明完整性和未被更改；仅有后台系统演示，无法证明签名人实际参与；以及证据不符合数据电文“原件”形式要求等。"
  - q: "企业使用电子签章要注意什么，才能“经得起诉”？"
    a: "核心有三点：使用经CA机构认证的数字证书签章，而不是简单的图片印章；通过可靠方式固定签署过程证据，证明“是谁签的”“签后没改过”；妥善保存可调取的原始数据电文，满足原件形式要求。具体可结合自身业务场景咨询专业律师。"
---
导语：电子签章≠当然有效
...
<img src="/articles/electronic-signature-validity/01-comparison-invalid-scenarios.png" alt="电子签章无效高频情形" loading="lazy" decoding="async" />
...
<img src="/articles/electronic-signature-validity/02-infographic-case-summary.png" alt="电子签章裁判案例总结" loading="lazy" decoding="async" />
...
<img src="/articles/electronic-signature-validity/03-framework-valid-logic.png" alt="可靠电子签章效力判断框架" loading="lazy" decoding="async" />
